...
def calculate_vat_to_be_paid_by_jurisdiction(
    ...
    *,
    ...
    """
    Calculate VAT payable totals grouped by jurisdiction.

    Args:
        transactions: iterable of mappings containing jurisdiction, amount, and VAT rate.
        jurisdiction_key: field name used for jurisdiction.
        amount_key: optional explicit amount field name. If omitted, common keys are auto-detected.
        vat_rate_key: optional explicit VAT rate field name. If omitted, common keys are auto-detected.
        rates_are_percentages:
            - True: interpret rates as percentages (e.g., 20 -> 20%).
            - False: interpret rates as decimal fractions (e.g., 0.20 -> 20%).
            - None: auto-detect per record (values greater than 1 are treated as percentages).
        rounding_places: decimal places for final jurisdiction totals.

    Returns:
        Mapping of jurisdiction code/name to rounded VAT payable amount.
    """

...
def generate_vat_to_be_paid(
    ...
    - vat_rate: number-like decimal rate e.g. 0.20 (required when vat_amount missing)
...
def generate_vat_to_be_paid_from_json(input_path: str | Path) -> dict[str, JurisdictionVatTotals]:

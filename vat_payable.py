...
def calculate_vat_payable_by_jurisdiction(
    ...
    - jurisdiction (str): jurisdiction identifier, such as country code
    ...
    - vat_amount (optional number): if present, uses VAT amount directly
    """
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate VAT payable per jurisdiction from transaction data."
    )
    parser.add_argument(
        "input_json",
        type=Path,

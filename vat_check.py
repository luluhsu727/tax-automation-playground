"""CSV-oriented VAT checking and jurisdiction summary generation.

This module reads transaction CSV files, computes per-transaction VAT payable
and writes both transaction-level output and a jurisdiction-level summary.
"""

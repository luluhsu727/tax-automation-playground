...
class VatCheckTests(unittest.TestCase):
    ...
    def test_supports_country_alias_and_rejects_unknown_jurisdiction(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with self.assertRaises(ValueError) as context:
                process_transactions(input_csv, output_csv, summary_csv)
            self.assertIn("Unsupported jurisdiction code: XX", str(context.exception))
    ...
    def test_rejects_non_numeric_fields(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with self.assertRaises(ValueError) as context:
                process_transactions(input_csv, output_csv, summary_csv)
            self.assertIn("Invalid value for 'revenue'", str(context.exception))

...
def test_compute_summary_with_per_row_rates() -> None:
    transactions = [
        {"jurisdiction": "DE", "taxable_amount": Decimal("100.00"), "vat_rate": Decimal("0.17")},
        {"jurisdiction": "DE", "taxable_amount": Decimal("100.00"), "vat_rate": Decimal("0.20")},
    ]
